...
CREATE TABLE IF NOT EXISTS `vr_video_sources` (
    ...
    `game_schedule_id` INT UNSIGNED NULL COMMENT 'FK to game_schedules; NULL for non-game footage',
...
CREATE TABLE IF NOT EXISTS `vr_video_clips` (
    ...
    `game_schedule_id` INT UNSIGNED NULL COMMENT 'FK to game_schedules',
    `title` VARCHAR(255) NOT NULL,
    `description` TEXT NULL,
    ...
    `updated_by` INT UNSIGNED NULL COMMENT 'FK to users',
...
CREATE TABLE IF NOT EXISTS `vr_clip_athletes` (
    `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
    `clip_id` INT UNSIGNED NOT NULL COMMENT 'FK to vr_video_clips',
    `athlete_id` INT UNSIGNED NOT NULL COMMENT 'FK to users (role=athlete)',
...
CREATE TABLE IF NOT EXISTS `vr_game_plans` (
    `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
    `game_schedule_id` INT UNSIGNED NULL COMMENT 'FK to game_schedules; NULL for practice plans',
    `team_id` INT UNSIGNED NOT NULL COMMENT 'FK to teams',
...
CREATE TABLE IF NOT EXISTS `vr_calendar_imports` (
    ...
    `imported_by` INT UNSIGNED NOT NULL COMMENT 'FK to users',
    `created_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    `updated_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `vr_video_permissions` (
    ...
    `granted_by` INT UNSIGNED NOT NULL COMMENT 'FK to users',
    `created_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    `updated_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    PRIMARY KEY (`id`),
